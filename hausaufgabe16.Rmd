...
Wie ist der Zusammenhang zwischen Gewicht und Preis?
```{r}
ggplot(diamonds.metric,aes(x=weight.kg,y=price.$)) +  geom_point() + geom_smooth(method="lm")
m4 <- lm(price.$ ~ weight.kg, data=diamonds.metric)
print(summary(m4))
```
